...
class XMSUtils {
	...
	// import com.ami.projects.Common.User20;
	// import mx.core.Application;
	// import mx.controls.ComboBox;
	// let lg: ELang;
	// let _app = {} as any;//mx.core.Application.application;
	// let _gd: XMSData = app.;
	static foo = "orig";
	//_____________________________________________________________________________sd_
	//==============================================================================
	...
	public static registerLanguageFile(elangobj: any): void {
		// lg = elangobj;
	}
	...
	//______________________________________________________________________________
	//==============================================================================
	public static createDeviceNameString(did:string, pluginID: string, returnblankifmissing: Boolean = false): string {
	...
	//______________________________________________________________________________
	//==============================================================================
	public static createDeviceNameStringfromEPID(epid: string, returnblankifmissing: Boolean = false):string {
	...
	//______________________________________________________________________________
	//==============================================================================
	public static createDeviceNameStringfromNode(node: any): string {
	...
	public static createEntityNameString(eid: String): String {
	...
	public static createEntityNameStringFromNode(node: any, ignoreoffline: Boolean = false): string {
	...
	public static getDeviceTypeString(devtype: Number, plugin: String = null): String {
	...
	public static getPluginName(plugin: String = null): String {
		var pid: String = (plugin == null ? "_gd.currentActivePluginID" : plugin);
	...
	public static processResponse(event: any, pretext: String, posttext: String,
	...
	public static getIPMIDatetoLocal(ts: number, zerostring: String = ""): String {
		if (ts > 32) {
	...
	public static alert(txt: String): any {
		/* public static alert(txt: String): IFlexDisplayObject {
	...
	// Brandon B 8/20/10
	public static show(htmltext: string = "", title: string = "", flags: number = 0x4, parent: any = null,
	...
	public static getIPfromHex(ips: String): String {
	...
	public static getMACfromHex(mac: String): String {
	...
	public static getHexfromMAC(mac: String): String {
	...
	public static getHexfromIP(ip: String): String {
	...
	public static getHex(val: Number, upper: Boolean = true, leading: string = "0x"): String {
	...
	public static selectComboBoxIndexfromData(cmb: any, data: Object, datafield: string = "data"): void {
		var i: number = 0;
	...
	public static htmlBold(str: String): String {
		return "<b>" + str + "</b>";
	}
	...
	public static htmlItalic(str: String): String {
		return "<i>" + str + "</i>";
	}
	//______________________________________________________________________________
	//==============================================================================
	...
	public static htmlColorSize(str: String, color: String = "", size: String = ""): String {
	...
	public static htmlStyle(str: String, bold: Boolean = false, italic: Boolean = false, color: String = "", size: String = ""): String {
		if (bold) {
	...
	public static offsetLeft(o: any): number {
		var l: number = 0;
	...
	public static offsetTop(o: any): number {
		var t: number = 0;
	...
	public static setupControlReadPermission(obj: any, action: XMSConstants): void {
	...
	public static setupControlWritePermission(arObjectList: Array<any>, action: number = XMSConstants.CONTROLACTION_DISABLE, bAllowEnable: Boolean = true): Boolean {
	...
	public static checkWriteAccess(): Boolean {
		// var user: User20 = _gd.currentUser;
	...
	public static getPluginNodefromDevID(devid: string, pluginID: string): any {
	...
	public static getNodefromDevID(devid: string, pluginID: string): any {
	...
	public static getEntityfromID(eid: String): any {
	...
	public static getPluginReferencebyID(pluginID: String): any {
		// public static getPluginReferencebyID(pluginID: String): IXMSPlugins {
		var pref: any = null;
	...
	public static checkGUIReservedDevice(dtype: number): Boolean {
		switch (dtype) {
	...
	public static checkSupportedDevice(dtype: number): Boolean {
	...
	public static checkPluginsSupported(): Boolean {
	...
	public static showWindow(window: any, modal: Boolean = true, xscale: Number = 0, yscale: Number = 0): any {
	...
	public static showWindowatCursor(window: any, offsetX: number = 10, offsetY: number = 10, modal: Boolean = true): any {
	...
	public static adjustFontSize(increment: Number, specificstylename: String = ""): void {
	...
	public static createCauseCodeString(causecode: number): string {
	...
	public static getGlobalHealthString(health: number, showtrap: Boolean = true): string {
	...
	public static getGlobalHealthIcon(health: number, size: number = 1): any {
	...
	public static getTaskStatusStyles(stat: number): any {
		// public static getTaskStatusStyles(stat: int): XMSTaskStyles {
	...
	public static getDeviceIcons(node: any): Object {
		// public static function getDeviceIcons(node: XML): Object {
	...
	public static roundDec(numIn: number, decimalPlaces: number): Number {
	...
	public static db(msg: String, typeoverride: String = "MessagingWindow.MWTYPE_DEBUG"): void {
		// Developer Note:
	...
	public static dbi(msg: String): void {
	...
	public static getTokenfromString(token: string, source: string): String {
	...
	public static getUserSetting(token: string): string {
	...
	public static addEditUserSetting(token: string, value: string): void {
	...
	//______________________________________________________________________________
	//==============================================================================
	public static isDeviceSelected(devid: string, pluginid: string): Boolean {
	...
	public static getAlertDests(sourceids: Array<any>, callback: Object): void {
	...
	public static getStyle(stylename: String, style: String): any {
	...
	public static getStyleAsColor(stylename: String, style: String): any {
	...
	public static getProtocolId(pluginID: string, protocolname: string): number {
	...
	public static getProtocolNamefromId(pid: number): string {
	...
	public static getCategoryName(catid: string): string {
	...
	public static checkIfUpdateMode(status: number): Boolean {
	...
	public static getNameFromDisplayName(displayname: string): string {
	...
	public static getKeywordsFromDisplayName(displayname: string): Array<any> {
		var arRet: Array<any> = [];
		var keywordsstart: number = displayname.indexOf("#");
		if (keywordsstart != -1) {
	...
	public static getKeywordsStringFromDisplayName(displayname: String): string {
		var retstr: string = "";
		var keywordsstart: number = displayname.indexOf("#");
		if (keywordsstart != -1) {
	...
	public static setKeywordstoDisplayName(item: Object, keywords: string): string {
	...
	//______________________________________________________________________________
	//==============================================================================
	public static tokenReplace(origstring: string, tokens: Array<any>): string {
		var i: number = 0;
	...
	//______________________________________________________________________________
	//==============================================================================
	public static getDepth(item: Object): number {
		var count: number = 0;
	...
	public static getIconbyClassandName(classandname: string): any {
		var retval: any = null;
	...
	public static getSizeInUnits(size: number, unit: string = "bytes"): string {
		var memory: string = '';
		if (size != -1) {
			if (unit == "gb") {
	...
	public static getCommaSeparatedValuestoArray(items: string, sort: number): Array<any> {
		var vals: Array<any> = items.split(/\s*,\s*/);	// get words out of user's string and trim space
		// vals.sort(sort);
		return vals;
	}

	public static getArraytoCommaSeparatedString(items: Array<any>, propertyname: String = ""): string {
	...
	public static tokenizestrings(strin: string, descdata: string): string {
		var ar: Array<any> = [];
	...
	public static tokenizestringswitharray(strin: string, descdata: Array<any>): String {
		var str: String = strin;
