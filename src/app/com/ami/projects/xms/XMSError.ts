//----------------------------------------------------------------------------//
// Application level error handler.  Translates error codes to strings.
//----------------------------------------------------------------------------//
// import com.ami.GUISE.Localization.ELang;
// import com.ami.Graphics.*;
// import com.ami.projects.Common.MessagingWindow;
// import com.ami.projects.XMS.XMSEvents.XMSLicensingEvent;
// import com.ami.projects.XMS.XMSEvents.XMSSecurityEvent;
'use strict';

class XMSError {
    static serveraddress: string = "";
    static useoffline: Boolean = false;
    static lg: Object = null;
    static logout: Function = null;
    static appObject: Object = null;//mx.core.Application.application;

    constructor() { };	// static class, no constructor
     ...
     *
   */
    // public static registerLanguageFile(elangobj:ELang):void
    static registerLanguageFile(): void {
        // lg=elangobj;
    }
    /**
   ...
   * @param app The application object
     *
   */
    //    public static function registerApplication(app:Application):void
    //    {
    //       appObject=app;
    //    }
    /**
   ...
   */
    ...
    static registerLogout(lofunc: Function): void {
        // logout=lofunc;
    }
     ...
     *
     * A default initializer is given for pluginid as base for any static classes
     * that need to call base level error checking, esp for cc codes (see TaskConsole).
   */
    public static checkResponseOK(errcode: number, pluginid: String = "base"):Boolean {
   ...
   */
    static translateErrorCode(code: number, pluginid: string): string {
        /* if (lg == null) {
    ...
    static translateValidationCode(code: string): string {
        if (XMSError.lg == null) {
            // NOTE this string cannot be localized, leave it as English
            return "An error has occurred before the language strings could be loaded.  The error code is: " + code;
        };
    ...
    // formatted text. :)
    static alertErrorCode(code: number, pluginid: String, icon: any = null): any {
        ...
        return a;*/
        return XMSError.alertErrorMessagewithTitle("alertErrorCode", "error");
    }
    static alertErrorMessage(msg: String, icon: any = null): any {
        /* let a: Alert;
        a = Alert.show(msg,
            null,
            mx.controls.Alert.OK,
        ...
        a.height += 10;
        return a; */
        return XMSError.alertErrorMessagewithTitle("alertErrorMessage", "error");
    }
    ...
    static alertGenericError(msg: String): any {
        // return XMSError.alertErrorMessagewithTitle(lg.getString("STR_XMSERROR_ERRO"), msg);
        return XMSError.alertErrorMessagewithTitle("alertGenericError", "error");
    }

    //------------------------------------------------------//
    //------------------------------------------------------//
    static alertUnderConstruction(msg: String = ""): any {
        ...
        return XMSError.alertErrorMessagewithTitle("new", "error");
    }

    static alertGenericResult(msg: String = "", title: String = ""): any {
    ...
    static alertGenericAttention(msg: String = "", title: String = ""): any {
        /*  return alertErrorMessagewithTitle(title,
             msg,
             IconsDialog.imgAttentionDialog); */
        return XMSError.alertErrorMessagewithTitle("new", "success");
    }

    //------------------------------------------------------//
    // Generic success messages with a bold "Success!" title, followed by the string.
    //------------------------------------------------------//
    static alertGenericSuccess(msg: String): any {
    ...
    //------------------------------------------------------//
    static alertErrorMessagewithTitle(title: String, msg: String, icon: any = null): any {
        /* if (icon == null) {
